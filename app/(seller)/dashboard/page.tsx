        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-sm">
            <div className="mb-5 flex items-center justify-between">
              ...
              <button type="button" className="text-sm font-semibold text-primary hover:text-secondary">
                + Add new item
              </button>
            </div>
            ...
            <div className="space-y-4">
              {listings.map((listing) => (
                <div key={listing.name} className="flex items-center justify-between gap-4 rounded-[1.25rem] bg-[#fffaf0] p-4">
                  <div>
          ...
          <div className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              {[{ label: 'Views', value: '1,420' }, { label: 'Favorites', value: '210' }, { label: 'Cart adds', value: '89' }].map((item) => (
